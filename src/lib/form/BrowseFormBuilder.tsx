...
const getBrowseFormBuilder: FormBuilderGetter = (
  translate: (pointer: string) => string,
) => {
  return {
    formBuilder: [
      {
      ...
      },
      {
        ...
        label: (
          <>
            <EuroIcon width={'0.5938rem'} height={'0.6875rem'} />{' '}
            {translate('form.priceRange')}
          </>
        ),
        rangeMin: 0,
        rangeMax: 100,
      ...
      },
      {
        ...
        label: (
          <>
            <Star width={'0.875rem'} height={'0.875rem'} />{' '}
            {translate('form.reviewsNumberRange')}
          </>
        ),
        rangeMin: 0,
        rangeMax: 5,
