...
export default function BrowseLayout({ children }: { children: ReactNode }) {
    ...
    const getFilterFormOriginalData = () => {
        const entries = Object.entries(UrlTransformer.transformSearchBooksQuery(searchParams, false));
        const record: Record<string, string | string[] | number | boolean | number[] | undefined> = {};
